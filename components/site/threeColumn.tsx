export default function threeColumn() {
    return (
        <div className="grow flex flex-col justify-between items-stretch bg-slate-100">
            ...
            <div className=" basis-4/6 grow flex lg:flex-row sm:flex-col flex-wrap content-center bg-pink-100">
                <div className="lg:w-1/3 lg:min-h-80 sm:w-full bg-green-300">
                ...
                <div className="lg:w-1/3 sm:w-full bg-purple-400">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et dolore magna
                    aliqua. Ut enim ad minim veniam, quis nostrud exercitation
                    ullamco laboris nisi ut aliquip ex ea commodo consequat.
                ...
                <div className="lg:w-1/3 sm:w-full bg-orange-300">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et dolore magna
                    aliqua. Ut enim ad minim veniam, quis nostrud exercitation
                    ullamco laboris nisi ut aliquip ex ea commodo consequat.
