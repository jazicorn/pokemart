...
2. [Project](project/_index.md)
   ...
   2. [Client](project/client/_index.md)
      ...
      2. [Languages](project/client/languages/_index.md)
      3. [Libraries](project/client/libraries/_index.md)
      4. [Tools](project/client/tools/_index.md)
   3. [Server](project/server/_index.md)
      1. [Authentication](projects/../project/server/authentication/_index.md)
      2. [Databases](projects/../project/server/databases/_index.md)
   4. [Devops](project/devops/_index.md)
      1. [Analytics](project/devops/analytics/_index.md)
      2. [Deployment](project/devops/deployment/_index.md)
      3. [Tools](project/devops/tools/_index.md)
